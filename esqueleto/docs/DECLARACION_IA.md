...
| --- | --- | --- | --- | --- | --- | --- |
| E1 |11/9  |ChatGPT  |Orientación sobre la lectura de archivos CSV,Ayuda para comprender Git/GitHub. explicacion catálogo, colección principal, pila y cola.  |with open("data/recetas.csv", "r", encoding="utf-8") as archivo:  |El resto.  |   |
| E2 |  |  |  |  |  |  |
| E3 |  |  |  |  |  |  |
| E4 |  |  |  |  |  |  |
| E5 |  |  |  |  |  |  |
